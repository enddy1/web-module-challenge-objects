...
*/
reviews.push({name: 'james', rating: 2, feedback: 'hello friend' });
...
*/
// ; after you declare a variable , or after you invoke a function
...
function getLastReview(newReviews) {
 ...
 return `${review.name} gave the restaurant a ${review.rating} star review, and their feedback was: ${review.feedback}`;/*Your code here*/
} 
